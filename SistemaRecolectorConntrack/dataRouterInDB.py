...
class DataRouterInDB(ConnectionPostgresql):
    
    def __init__(self):
        super(DataRouterInDB, self).__init__()
    
    def saveDataInPostgresql(self):

        # fecha y hora
        now = datetime.datetime.now()
        #Abriendo la conexion con postgresql
